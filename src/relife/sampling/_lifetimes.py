...
from relife.lifetime_models import FrozenParametricLifetimeModel
...
def sample_lifetimes(
    model: FrozenParametricLifetimeModel[*Ts],
...
def sample_lifetimes(
    model: FrozenParametricLifetimeModel[*Ts] | RenewalProcess,
    size: int | tuple[int, ...] | None = None,
    a0: AgeArg = None,
    ar: AgeArg = None,
    seed: Seed = None,
