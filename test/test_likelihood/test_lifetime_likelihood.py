...
def test_structured_lifetime_data_with_2d(lifetime_data_2d):
    ...
    assert np.all(
        lifetime_data_2d.left_truncation.values == np.array([3, 5, 3, 1, 9]).reshape(-1, 1)
    )
