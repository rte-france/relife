...
html_theme_options = {
    "announcement": "<em>beta version</em> : the code is still in development (expected release by the end of April 2025). The documentation might not be up-to-date",  # annoucement bar
